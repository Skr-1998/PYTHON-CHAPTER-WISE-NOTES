...
def solveAllPath(maze, i, j, N, visited,current_path,all_paths,):  
    ...
    if isSafe(maze,i+1,j,visited,N):
        ...
        solveAllPath(maze,i+1,j,N,visited,current_path,all_paths)
        current_path.pop() #Backtrack

    #Right
    if isSafe(maze,i,j+1,visited,N):
        current_path.append("R") #D for down
        solveAllPath(maze,i,j+1,N,visited,current_path,all_paths)
        current_path.pop() #Backtrack

    #UP
    if isSafe(maze,i-1,j,visited,N):
        current_path.append("U") #D for down
        solveAllPath(maze,i-1,j,N,visited,current_path,all_paths)
        current_path.pop() #Backtrack
...
solveAllPath(maze,0, 0, N, visited,[],all_paths)
